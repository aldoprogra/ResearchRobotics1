\hypertarget{md__root__desktop__research_robotics1__research_robotics1_final_assignment__r_e_a_d_m_e_autotoc_md0}{}\doxysection{Introduction}\label{md__root__desktop__research_robotics1__research_robotics1_final_assignment__r_e_a_d_m_e_autotoc_md0}
I was asked to develop a program in which the user control the robot in a 3D simulation enviroment in three different ways\+: 1) autonomously reach a x,y coordinate inserted by the user 2) drive the robot with the keyboard 3) drive the robot with keyboard but avoiding collisions\hypertarget{md__root__desktop__research_robotics1__research_robotics1_final_assignment__r_e_a_d_m_e_autotoc_md1}{}\doxysection{How to install}\label{md__root__desktop__research_robotics1__research_robotics1_final_assignment__r_e_a_d_m_e_autotoc_md1}
...
\end{DoxyCode}
\hypertarget{md__root__desktop__research_robotics1__research_robotics1_final_assignment__r_e_a_d_m_e_autotoc_md2}{}\doxysection{How to run}\label{md__root__desktop__research_robotics1__research_robotics1_final_assignment__r_e_a_d_m_e_autotoc_md2}
...
\end{DoxyCode}
\hypertarget{md__root__desktop__research_robotics1__research_robotics1_final_assignment__r_e_a_d_m_e_autotoc_md3}{}\doxysection{Pseudocode}\label{md__root__desktop__research_robotics1__research_robotics1_final_assignment__r_e_a_d_m_e_autotoc_md3}
1) Autonomous drive
